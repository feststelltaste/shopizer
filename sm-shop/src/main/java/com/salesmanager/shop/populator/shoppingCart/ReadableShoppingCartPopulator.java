...
public class ReadableShoppingCartPopulator extends AbstractDataPopulator<ShoppingCart, ReadableShoppingCart> {
	...
	public ReadableShoppingCart populate(ShoppingCart source, ReadableShoppingCart target, MerchantStore store,
    	...
    	Validate.notNull(priceUtils, "Requires to set priceApi");
    	...
    	try {
            ...
            if(items!=null) {
                ...
                for(com.salesmanager.core.model.shoppingcart.ShoppingCartItem item : items) {
					...
					shoppingCartItem.setDisplaySubTotal(priceUtils.getStoreFormattedAmountWithCurrency(store, subTotal));
            ...
            target.setDisplaySubTotal(priceUtils.getStoreFormattedAmountWithCurrency(store, orderSummary.getSubTotal()));
           
            
            target.setTotal(orderSummary.getTotal());
            target.setDisplayTotal(priceUtils.getStoreFormattedAmountWithCurrency(store, orderSummary.getTotal()));
