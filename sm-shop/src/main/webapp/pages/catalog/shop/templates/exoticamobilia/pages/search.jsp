...
{{/products}}
 ...
 $(function(){
 	...
 	function search() {
 		...
 		var url = '<%=request.getContextPath()%>/catalog/services/public/search/<c:out value="${requestScope.MERCHANT_STORE_CODE}"/>/<c:out value="${requestScope.LANGUAGE_CODE}"/>/' + START_COUNT_PRODUCTS + '/' + MAX_PRODUCTS + '/search.json';
