...
public class CatalogUpdateEventListener implements PostUpdateEventListener {
    ...
    @Autowired
    public CatalogUpdateEventListener(ProductRepository productRepository, KafkaTemplate<String, AbstractCatalogDTO> kafkaTemplate) {
    ...
    public void onPostUpdate(PostUpdateEvent event) {
        if (event.getEntity() instanceof Product) {
            ...
            kafkaTemplate.send("product_option_value", productOptionValue.toDTO().setEventType(AbstractCatalogCrudDTO.EventType.UPDATE));
        }
    }
