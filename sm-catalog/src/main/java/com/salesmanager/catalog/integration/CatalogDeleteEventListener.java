...
@Component
public class CatalogDeleteEventListener implements PostDeleteEventListener {
    ...
    @Autowired
    public CatalogDeleteEventListener(ProductRepository productRepository, KafkaTemplate<String, AbstractCatalogCrudDTO> kafkaTemplate) {
    ...
    public void onPostDelete(PostDeleteEvent event) {
        if (event.getEntity() instanceof Product) {
            ...
            kafkaTemplate.send("product", (AbstractCatalogCrudDTO) product.toDTO().setEventType(EventType.DELETE));
            ...
            kafkaTemplate.send("product_option", (AbstractCatalogCrudDTO) productOption.toDTO().setEventType(EventType.DELETE));
            ...
            kafkaTemplate.send("product_option_value", (AbstractCatalogCrudDTO) productOptionValue.toDTO().setEventType(EventType.DELETE));
        }
    }
