...
public class CatalogDeleteEventListener implements PostDeleteEventListener {
    ...
    @Autowired
    public CatalogDeleteEventListener(ProductRepository productRepository, KafkaTemplate<String, AbstractCatalogDTO> kafkaTemplate) {
    ...
    public void onPostDelete(PostDeleteEvent event) {
        if (event.getEntity() instanceof Product) {
            ...
            kafkaTemplate.send("product", product.toDTO().setEventType(EventType.DELETE));
            ...
            kafkaTemplate.send("product_option", productOption.toDTO().setEventType(AbstractCatalogCrudDTO.EventType.DELETE));
            ...
            kafkaTemplate.send("product_option_value", productOptionValue.toDTO().setEventType(AbstractCatalogCrudDTO.EventType.DELETE));
        }
    }
