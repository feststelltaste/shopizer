...
public class CatalogCreatedEventListener implements PostInsertEventListener {
    ...
    @Autowired
    public CatalogCreatedEventListener(ProductRepository productRepository, KafkaTemplate<String, AbstractCatalogCrudDTO> kafkaTemplate) {
    ...
    public void onPostInsert(PostInsertEvent event) {
        if (event.getEntity() instanceof Product) {
            ...
            kafkaTemplate.send("product", (AbstractCatalogCrudDTO) product.toDTO().setEventType(EventType.CREATED));
            ...
            kafkaTemplate.send("product", (AbstractCatalogCrudDTO) product.toDTO().setEventType(EventType.UPDATED));
            ...
            kafkaTemplate.send("product_option", (AbstractCatalogCrudDTO) productOption.toDTO().setEventType(EventType.CREATED));
            ...
            kafkaTemplate.send("product_option_value", (AbstractCatalogCrudDTO) productOptionValue.toDTO().setEventType(EventType.CREATED));
        }
    }
