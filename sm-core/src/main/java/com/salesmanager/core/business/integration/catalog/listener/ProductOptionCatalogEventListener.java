...
public class ProductOptionCatalogEventListener {
    ...
    public void handleProductOptionCreateEvent(CreateEvent<ProductOptionDTO> event) throws ServiceException {
    ...
    @TransactionalEventListener
    @Transactional(propagation = Propagation.REQUIRES_NEW)
    public void handleProductOptionDeleteEvent(DeleteEvent<ProductOptionDTO> event) {
        ProductOptionDTO productOptionDTO = event.getDto();
        if (productOptionDTO != null) {
    ...
    @TransactionalEventListener
    @Transactional(propagation = Propagation.REQUIRES_NEW)
    public void handleProductOptionUpdateEvent(UpdateEvent<ProductOptionDTO> event) throws ServiceException {
        ProductOptionDTO productOptionDTO = event.getDto();
        if (productOptionDTO != null) {
            ProductOptionInfo productOption = createProductOptionInfo(productOptionDTO);
            this.productOptionInfoService.save(productOption);
